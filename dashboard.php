            ...
            <div class="card-group">
               ...
               <div class="card bg-light mb-3 " style="width:15rem; height: 15rem;">
                  <div class="card-body">
                     ...
                     <a href=" index.php">
                        <h5 class="card-title" style=" color:#000">FACE RECOGNITION:</h5>
                     </a>
               ...
               <div class="card bg-light mb-3" style="width:15rem; height: 15rem;">
                  <div class="card-body">
                     <br>
                     <a href=" index.php">
                        <h5 class="card-title" style=" color:#000">Registered User</h5>
                     </a>
               ...
               <div class="card bg-light mb-3 " style="width:15rem; height: 15rem;">
                  <div class="card-body">
                     <br>
                     <a href=" index.php">
                        <h5 class="card-title" style=" color:#000">Requests:</h5>
                     </a>
