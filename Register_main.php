                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form class="form-upload" action="reg_append.php<?php echo "?&ru_firstname=" . $ru_firstname . "&ru_lastname=" . $ru_lastname . "&ru_studentid=" . $ru_studentid . "&ru_course=" . $ru_course . "&fileupload[]=" . $_FILES['fileupload']; ?>" method="POST" enctype="multipart/form-data">
